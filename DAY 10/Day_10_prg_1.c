...
//Using loop check the condition every request 0
...
 }
 printf("\n");
//Using loop check the condition every request 1
...
 }
 printf("\n");
//Using loop check the condition every request 2
...
 }
  printf("\n");
//Using loop check the condition every request4
...
 }
  printf("\n");
//Using loop check the condition every request 3
